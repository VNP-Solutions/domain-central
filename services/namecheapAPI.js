    ...
    async purchaseDomain(domain, years = 1) {
        try {
            const response = await this.makeRequest('namecheap.domains.create', {
                ...
                AuxBillingFirstName: 'Parvez',
                AuxBillingLastName: 'Ahmed',
                AuxBillingAddress1: '8244 Gunnar drive',
                AuxBillingCity: 'Fulton',
                AuxBillingStateProvince: 'MD',
                AuxBillingPostalCode: '20759',
                AuxBillingCountry: 'US',
                AuxBillingPhone: '+1.6674476004',
                AuxBillingEmailAddress: 'itsupport@vnpsolutions.com',
                TechFirstName: 'Parvez',
                TechLastName: 'Ahmed',
                TechAddress1: '8244 Gunnar drive',
                TechCity: 'Fulton',
                TechStateProvince: 'MD',
                TechPostalCode: '12345',
                TechCountry: 'US',
                TechPhone: '+1.6674476004',
                TechEmailAddress: 'itsupport@vnpsolutions.com',
                AdminFirstName: 'Parvez',
                AdminLastName: 'Ahmed',
                AdminAddress1: '8244 Gunnar drive',
                AdminCity: 'Fulton',
                AdminStateProvince: 'MD',
                AdminPostalCode: '20759',
                AdminCountry: 'US',
                AdminPhone: '+1.6674476004',
                AdminEmailAddress: 'itsupport@vnpsolutions.com',
                RegistrantFirstName: 'Parvez',
                RegistrantLastName: 'Ahmed',
                RegistrantAddress1: '8244 Gunnar drive',
                RegistrantCity: 'Fulton',
                RegistrantStateProvince: 'MD',
                RegistrantPostalCode: '12345',
                RegistrantCountry: 'US',
                RegistrantPhone: '+1.6674476004',
                RegistrantEmailAddress: 'itsupport@vnpsolutions.com'
            });
